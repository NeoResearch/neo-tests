...
ARGS="--build-arg NEO_VM_URL=$NEO_VM_URL 
--build-arg NEO_CLI_BLOCKCHAIN_URL=$NEO_CLI_BLOCKCHAIN_URL  
--build-arg NEO_CLI_BRANCH=$NEO_CLI_BRANCH 
--build-arg NEO_CLI_COMMIT=$NEO_CLI_COMMIT 
--build-arg NEO_BLOCKCHAIN_URL=$NEO_BLOCKCHAIN_URL 
--build-arg NEO_BLOCKCHAIN_BRANCH=$NEO_BLOCKCHAIN_BRANCH 
--build-arg NEO_BLOCKCHAIN_COMMIT=$NEO_BLOCKCHAIN_COMMIT 
--build-arg NEO_PLUGINS_URL=$NEO_PLUGINS_URL 
--build-arg NEO_PLUGINS_BRANCH=$NEO_PLUGINS_BRANCH 
--build-arg NEO_PLUGINS_COMMIT=$NEO_PLUGINS_COMMIT 
--build-arg LOCAL_NEO_BLOCKCHAIN=$LOCAL_NEO_BLOCKCHAIN 
--build-arg LOCAL_NEO_CLI_BLOCKCHAIN_PATH=$LOCAL_NEO_CLI_BLOCKCHAIN_PATH 
--build-arg NEO_BLOCKCHAIN_RUN_TESTS=$NEO_BLOCKCHAIN_RUN_TESTS 
--build-arg LOCAL_NEO_CLI_BLOCKCHAIN=$LOCAL_NEO_CLI_BLOCKCHAIN 
--build-arg LOCAL_NEO_CLI_BLOCKCHAIN_PATH=$LOCAL_NEO_CLI_BLOCKCHAIN_PATH 
--build-arg SET_NEO_VM=$SET_NEO_VM 
--build-arg NEO_VM_URL=$NEO_VM_URL 
--build-arg NEO_VM_BRANCH=$NEO_VM_BRANCH 
--build-arg NEO_VM_COMMIT=$NEO_VM_COMMIT 
--build-arg LOCAL_NEO_VM=$LOCAL_NEO_VM 
--build-arg LOCAL_NEO_VM_URL=$LOCAL_NEO_VM_URL 
--build-arg ENVFILE=$ENVFILE"
